webpackJsonp([4], {
		...
		function (window, document) {
			...
			cmbShortcut.prototype = {
				...
				getIOSVersion: function () {
					...
					return this.isIOS() && match && match[1] && (version = match[1]),
						version
				},
				isAndroid: function () {
				...
				tryToCmblife: function (cmbUrl, downloadPage) {
					...
					ifr.src = cmbUrl,
						...
						setTimeout(function () {
							var t2 = Date.now(); (!t1 || t2 - t1 < inter + 100) && (hasApp = !1)
						},
							inter)
				},
	...
	145: function (module, exports, __webpack_require__) {
		...
		var seckillHomeCtrl = __webpack_require__(148),
			record = __webpack_require__(149),
			floatFilter = __webpack_require__(154),
			mod = angular.module("app.seckill.home", [record]);
		mod.controller("seckillHomeCtrl", seckillHomeCtrl),
			mod.filter("floatFilter", floatFilter),
			module.exports = mod
	},
	...
	147: function (module, exports, __webpack_require__) {
		exports = module.exports = __webpack_require__(4)(),
            exports.push([module.id, '.flex,\n.flex-center-middle,\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory,\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last {\n  display: -webkit-box; /* 老版本语法: Safari, iOS, Android browser, older WebKit browsers. */\n  display: -moz-box; /* 老版本语法: Firefox (buggy) */\n  display: -ms-flexbox; /* 混合版本语法: IE 10 */\n  display: -webkit-flex; /* 新版本语法: Chrome 21+ */\n  display: flex; /* 新版本语法: Opera 12.1, Firefox 22+ */\n}\n.flex-column {\n  display: -webkit-box; /* 老版本语法: Safari, iOS, Android browser, older WebKit browsers. */\n  display: -moz-box; /* 老版本语法: Firefox (buggy) */\n  display: -ms-flexbox; /* 混合版本语法: IE 10 */\n  display: -webkit-flex; /* 新版本语法: Chrome 21+ */\n  display: flex; /* 新版本语法: Opera 12.1, Firefox 22+ */\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n  -moz-box-orient: vertical;\n  -moz-box-direction: normal;\n  flex-direction: column;\n  -webkit-flex-direction: column;\n  -moz-flex-direction: column;\n}\n.flex-wrap {\n  -webkit-flex-wrap: wrap;\n  -webkit-box-lines: multiple;\n  -moz-flex-wrap: wrap;\n  flex-wrap: wrap;\n}\n.flex-x-center,\n.flex-center-middle {\n  -webkit-box-pack: center;\n  -moz-box-pack: center;\n  -webkit--moz-box-pack: center;\n  box-pack: center;\n  -webkit-justify-content: center;\n  -moz-justify-content: center;\n  justify-content: center;\n}\n.flex-x-start {\n  -webkit-box-pack: start;\n  -moz-box-pack: start;\n  -webkit--moz-box-pack: start;\n  box-pack: start;\n  -webkit-justify-content: flex-start;\n  -moz-justify-content: flex-start;\n  justify-content: flex-start;\n}\n.flex-x-between,\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory,\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last {\n  -webkit-box-pack: justify;\n  -moz-box-pack: justify;\n  -webkit--moz-box-pack: justify;\n  box-pack: justify;\n  -moz-justify-content: space-between;\n  -webkit-justify-content: space-between;\n  justify-content: space-between;\n}\n.flex-x-end {\n  -webkit-box-pack: end;\n  -moz-box-pack: end;\n  -webkit--moz-box-pack: end;\n  box-pack: end;\n  -webkit-justify-content: flex-end;\n  -moz-justify-content: flex-end;\n  justify-content: flex-end;\n}\n.flex-y-center,\n.flex-center-middle,\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last {\n  align-items: center;\n  -webkit-align-items: center;\n  -moz-align-items: center;\n  box-align: center;\n  -moz-box-align: center;\n  -webkit-box-align: center;\n}\n.flex-y-end {\n  -webkit-box-align: end;\n  -moz-align-items: flex-end;\n  -webkit-align-items: flex-end;\n  -align-items: flex-end;\n}\n.flex-1 {\n  box-flex: 1;\n  -webkit-box-flex: 1;\n  -moz-box-flex: 1;\n  flex: 1;\n  -webkit-flex: 1;\n  -moz-flex-grow: 1;\n}\n.seckill-home {\n  position: relative;\n  background-color: #f1f5f7;\n  min-height: 100vh;\n  overflow-x: hidden;\n}\n.seckill-home img[src=""],\n.seckill-home img:not([src]) {\n  opacity: 0;\n}\n.seckill-home .banner {\n  height: calc(100vw * 0.37);\n  background-color: #fff;\n}\n.seckill-home .banner >img {\n  width: 100%;\n  height: 100%;\n}\n.seckill-home .banner >button {\n  position: absolute;\n  top: 0.5rem;\n  right: 0.2rem;\n  width: 5.1rem;\n  height: 1.6rem;\n  border-radius: 0.8rem;\n  background-color: #000;\n  border: none;\n  color: #fff;\n  font-size: 0.9rem;\n}\n.seckill-home .time {\n  height: 3.5rem;\n  padding: 0 1.1rem 0 1.1rem;\n  background-color: #fff;\n}\n.seckill-home .time >div {\n  height: 100%;\n}\n.seckill-home .time >div >div:first-child {\n  color: #2c2c3c;\n}\n.seckill-home .time >div >div:nth-child(2) .timer {\n  width: 7.3rem;\n  height: 1.4rem;\n}\n.seckill-home .time >div >div:nth-child(2) .timer .timer-block {\n  width: 1rem;\n  height: 100%;\n  line-height: 1.65rem;\n  margin-left: 0.1rem;\n  background-color: #2c2c3c;\n  color: #fff;\n  font-size: 0.9rem;\n  border-radius: 0.2rem;\n  text-align: center;\n}\n.seckill-home .time >div >div:nth-child(2) .timer .timer-gap {\n  color: #2c2c3c;\n  margin: 0 0.1rem 0 0.1rem;\n}\n.seckill-home .time >div >div:nth-child(2) .next-round {\n  color: #ff5656;\n  font-weight: bold;\n}\n.seckill-home .seckill-home-campaigns {\n  overflow-y: auto;\n  -webkit-overflow-scrolling: touch;\n  padding-bottom: 3.1rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign >div:first-child {\n  color: #565663;\n  font-size: 0.9rem;\n  font-weight: bolder;\n  padding: 0 1.1rem 0 1.1rem;\n  height: 2.1rem;\n  margin-bottom: 1px;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods {\n  margin: 0 0.714285714285714rem 0.714285714285714rem 0.714285714285714rem;\n  border-radius: 0.357142857142857rem;\n  background-color: #fff;\n  padding: 1.071428571428571rem 0.714285714285714rem 1.071428571428571rem 0.714285714285714rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .goods-icon {\n  height: 5.714285714285714rem;\n  width: 5.714285714285714rem;\n  margin-right: 0.714285714285714rem;\n  border: 0.035714285714286rem solid #eee;\n  border-radius: 0.357142857142857rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .goods-icon >img {\n  height: 5.714285714285714rem;\n  width: 5.714285714285714rem;\n  border-radius: 0.357142857142857rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box {\n  margin: 0;\n  flex: 1;\n  width: 70%;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .name {\n  width: 95%;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  font-size: 1.071428571428571rem;\n  font-weight: bold;\n  color: #2c2c3c;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .price {\n  font-size: 0.785714285714286rem;\n  color: #6b6b76;\n  margin-top: 0.357142857142857rem;\n  text-decoration: line-through;\n  vertical-align: middle;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory {\n  width: 12.5rem;\n  margin-top: 0.5rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory .received {\n  font-size: 0;\n  font-weight: bold;\n  color: #2c2c3c;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory .received >span {\n  font-size: 0.785714285714286rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory .received .received-count {\n  font-family: Helvetica Neue;\n  color: #ed5349;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .inventory .remain {\n  font-size: 0.714285714285714rem;\n  color: #6b6b76;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .progress {\n  width: 12.5rem;\n  height: 0.928571428571429rem;\n  line-height: 0.928571428571429rem;\n  margin-top: 0.178571428571429rem;\n  border-radius: 1.071428571428571rem;\n  background-color: #f9cbc8;\n  font-size: 0;\n  overflow: hidden;\n  position: relative;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .progress .background {\n  border-radius: 1.071428571428571rem;\n  background: linear-gradient(-45deg, #ed5349 30%, #ee6057 31%, #ee6057 58%, #ed5349 59%);\n  background-size: 1.071428571428571rem 0.928571428571429rem;\n  height: 0.928571428571429rem;\n  line-height: 0.928571428571429rem;\n  padding-left: 0.571428571428571rem;\n  color: #fff;\n  position: absolute;\n  z-index: 1;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .progress .text {\n  z-index: 2;\n  position: absolute;\n  color: #fff;\n  font-size: 0.714285714285714rem;\n  text-align: left;\n  height: 0.928571428571429rem;\n  line-height: 0.928571428571429rem;\n  width: 100%;\n  top: 0.142857142857143rem;\n  padding-left: 0.571428571428571rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last {\n  margin-top: 0.714285714285714rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale {\n  height: 2.142857142857143rem;\n  line-height: 2.142857142857143rem;\n  color: #ed5349;\n  font-weight: bold;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-price {\n  float: left;\n  font-size: 0rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-price .number {\n  font-size: 1.285714285714286rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-price .text {\n  font-size: 0.714285714285714rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-plus {\n  float: left;\n  font-size: 1.285714285714286rem;\n  margin: 0.178571428571429rem 0.178571428571429rem 0 0.178571428571429rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-point {\n  font-size: 0;\n  float: left;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-point .number {\n  font-size: 1.285714285714286rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .sale .sale-point .text {\n  font-size: 0.714285714285714rem;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .btn-box .seckill-btn {\n  width: 5rem;\n  height: 2.142857142857143rem;\n  float: right;\n  border-radius: 1.785714285714286rem;\n  color: #fff;\n  font-weight: bold;\n  font-size: 1rem;\n  background-color: rgba(237,83,73,0.3);\n  outline: none;\n  border: none;\n}\n.seckill-home .seckill-home-campaigns .seckill-home-campaign .goods .info-box .last .btn-box .seckill-btn.active {\n  background-color: #ed5349;\n}\n.seckill-home .seckill-home-footer {\n  height: 2.857142857142857rem;\n  background-color: #fff;\n  color: #2c2c3c;\n  font-size: 1.071428571428571rem;\n  font-weight: bolder;\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  border-top: 1px solid #f1f5f7;\n  z-index: 10;\n}\n.seckill-home .seckill-home-footer >div {\n  height: 1.6rem;\n}\n.seckill-home .seckill-home-footer >div:first-child {\n  border-right: 1px solid #cbcbcb;\n}\n', ""])
	},
	148: function (module, exports) {
		module.exports = function ($stateParams, $state, $timeout, $window, $scope, CONSTANT, AXIO, UTIL, LOGIN, NATIVE, HOT_SPOTS, CAMPAIGNS) {
			...
			function init() {
				vm.confirmCheck = !0,
					vm.receiveAlarm = null,
					vm.payAlarm = null,
					vm.receiveTimer = null,
					vm.payTimer = null,
					vm.regExp = CONSTANT.STR_REG,
					HOT_SPOTS.getHotSpotsByCgName(vm, vm.cgName,
						function (data) {
							vm.hotSpots = data,
								CAMPAIGNS.getCampaignsByCgName(vm, vm.cgName,
									function (data) {
										vm.campaigns = data,
											getInventory()
									})
			...
			function getInventory() {
				vm.confirmCheck = !0,
					...
					vm.receiveTimer = null,
					vm.payTimer = null,
					$window.getInventoryCallback = function (resp) {
						AXIO.dealData(resp, {
							success: function (data) {
								switch (vm.inventory = data.inventory, vm.timeFlag = !1, data.countdownStatus) {
									...
									case 1:
										...
										initReceiveCounter(),
											vm.receiveAlarm.start(receiveCountdown);
										break;
									case 2:
										vm.timeTitle = vm.hotSpots.PanicBuyingPage.start.title,
											vm.timeFlag = !0;
										break;
									case 3:
							...
							$scope.$apply(),
							delete $window.getInventoryCallback
					},
					AXIO.post4Data({
			...
			function showSuccessTip(goodsInfo, campaignNo) {
				if (window.stormKill) {
					window.clearInterval(window.stormKill);
				}
				if (window.debug) {
					window.saveResult('cmbsuccess', JSON.stringify(goodsInfo));
				}
				vm.successBtn = {
					style: "long-button",
					disabled: !vm.payFlag
					...
					vm.showAlert = !0,
					UTIL.trackEventShenCe("newExchangePage", {
						pageName: "结果页",
						campaignGroupID: vm.cgName,
						campaignGroupName: vm.campaigns.campaignGroup.displayName,
			...
			function initReceiveCounter() {
				vm.receiveAlarm && vm.receiveAlarm.end(),
					vm.receiveTimer = null,
					vm.receiveAlarm = new UTIL.initAlarm(function (leftTime) {
						vm.receiveTimer = UTIL.transCounterObj(leftTime)
					},
						function () {
							vm.timeFlag = !0,
								vm.timeTitle = vm.hotSpots.PanicBuyingPage.start.title,
								vm.receiveTimer = UTIL.transCounterObj(0)
						})
			}
			function initPayCounter() {
				vm.payAlarm && vm.payAlarm.end(),
					vm.payTimer = null,
					vm.payAlarm = new UTIL.initAlarm(function (leftTime) {
						vm.payTimer = UTIL.transCounterStr(leftTime),
							vm.successBtn.text = vm.goodsInfo.isNeedPay ? "去支付(" + vm.payTimer + ")" : "入账中(" + vm.payTimer + ")"
					},
						function () {
							vm.payFlag = !0,
								vm.payTimer = UTIL.transCounterStr(0),
								vm.successBtn.disabled = !1,
								vm.successBtn.text = vm.goodsInfo.isNeedPay ? "去支付" : "查看我的抢购"
						})
			}
			...
			var vm = this,
				cmb = new cmbShortcut;
			return vm.isNotCmblife = cmb.getCmbVersion() === -1,
				vm.isNotCmblife ? void cmb.gotoCmblife() : $stateParams.cgName ? (vm.cgName = $stateParams.cgName, init(), $window.getInventory = getInventory, vm.receivePrize = function (goodsId, campaignNo, campaignTitle) {
					if (window.controlStartTime) {
						window.controlStartTime = window.controlStartTime
					} else {
						window.controlStartTime = 1578275980000
					}
					if (i < window.controlStartTime) {
						alert("活动尚未开始，请9点59分40秒再开始点击")
						return;
					}
					if (window.controlStartTime2) {
						window.controlStartTime2 = window.controlStartTime2
					} else {
						window.controlStartTime2 = 1578275999950
					}
					vm.isBtnActive(goodsId) && (goodsId ? vm.tmpGoodsId = goodsId : "", campaignNo ? vm.tmpCampaignNo = campaignNo : "", $window.receivePrizeCallback = function (resp) {
						AXIO.dealData(resp, {
							success: function (data) {
								if (data.respCode === CONSTANT.RESP_CODE.SUCCESS) {
									vm.confirmCheck = !0,
										...
										vm.goodsInfo = data.goodsInfo;
									var payCountdown = parseInt(data.payCountdown, 10); !isNaN(payCountdown) && payCountdown > 0 ? (vm.payFlag = !1, initPayCounter(), vm.payAlarm.start(payCountdown)) : vm.payFlag = !0,
										showSuccessTip(vm.goodsInfo, campaignNo);
									window.clearInterval(window.stormKill);
								}
							},
							sessionOut: function () {
							...
							fail: function (data) {
								...
								if (vm.confirmCheck = !0, data.respCode == CONSTANT.RESP_CODE.CYCLE_END) NATIVE.singleButtonAlert(null, msg, "确认", "getInventory");
									...
									$window[cbName] = function () {
										$window.location.href = CONSTANT.REDIRECT.NATIVE_CAMPAIGN,
											delete $window[cbName]
									},
										NATIVE.coupleButtonAlert(null, msg, "取消", null, "去看看", cbName)
									} else if (data.respCode == CONSTANT.RESP_CODE.INVENTORY_EMPTY) NATIVE.singleButtonAlert(null, msg, "确认", "getInventory");
								...
								data.respCode == CONSTANT.RESP_CODE.INVENTORY_EMPTY && (vm.inventory ? vm.inventory[goodsId] = "0" : (vm.inventory = {},
							...
							$scope.$apply(),
							delete $window.receivePrizeCallback,
							UTIL.trackEvent("抢购模型_主页_立即抢", vm.cgName + "_" + vm.campaigns.campaignGroup.displayName + "_" + campaignTitle),
						...
						window.stormKill = window.setInterval(function () {
							if (new Date().getTime() < controlStartTime2) {
								return;
							}
							$window.receivePrizeCallback = function (resp) {
								AXIO.dealData(resp, {
									success: function (data) {
										if (data.respCode === CONSTANT.RESP_CODE.SUCCESS) {
											vm.confirmCheck = !0,
									...
									fail: function (data) {
										if (window.debug) {
											window.saveResult('cmbfail', JSON.stringify(data));
										}
										var msg = vm.hotSpots.PanicBuyingPage.hasOwnProperty(data.respCode) ? vm.hotSpots.PanicBuyingPage[data.respCode].content : data.respMsg;
										if (data.respCode === CONSTANT.RESP_CODE.CONFIRM_CHECK) return $window.cancelReceive = function () {
											vm.confirmCheck = !0,
							...
							AXIO.post4Data({
								...
								params: {
									...
									campaignNo: campaignNo,
									goodsId: goodsId,
									confirmCheck: vm.confirmCheck ? "1" : "0"
								},
								callbackName: "receivePrizeCallback"
							})
						}, window.stormTimeInterval)
					)
				},
					...
					vm.progressStyle = function (remain, total) {
                        var percent = 0;
                        remain && total && total > 0 && total - remain > 0 && (percent = Math.floor((total - remain) / total * 100), percent = percent > 100 ? 100 : percent);
                        var text = percent + "%";
                        return percent >= 90 && 100 !== percent ? text = "即将抢光" : 100 === percent && (text = "已抢光"),
                        {
                            backgroundStyle: {
                                width: (percent <= 7 ? 7 : percent) + "%",
                                display: 0 === percent ? "none" : "block"
                            },
                            text: text,
                            textStyle: {
                                textAlign: percent >= 90 ? "center" : "left"
							}
						}
					},
	...
	149: function (module, exports, __webpack_require__) {
		var record = __webpack_require__(150);
		__webpack_require__(152);
		var mod = angular.module("app.seckill.record", []);
		mod.directive("record", record),
		...
		module.exports = function ($window, $timeout, AXIO, NATIVE, CONSTANT, UTIL, LOGIN) {
			...
			return {
				...
				link: function (scope) {
						...
						if (recordList && !(recordList.length <= 0)) {
							...
							for (var i = 0; i < recordList.length; i++) {
								vm.counterObj[i] = {
									...
									recordList[i].productName = recordList[i].productName.replace(/\+/g, " "),
									recordList[i].seckillTime = recordList[i].seckillTime.replace(/\+/g, " ");
								var payCountdownInt = parseInt(recordList[i].payCountdown, 10); !isNaN(payCountdownInt) && payCountdownInt > 0 && (vm.counterObj[i].endFlag = !1,
									function (i) {
										newAlarm = UTIL.initAlarm(function (leftTime) {
											...
											newAlarm.start(payCountdownInt),
											vm.recordAlarmList.push(newAlarm)
									}(i))
							}
						}
					}
					var vm = scope;
					vm.showMq = !0,
						vm.marquee = "请您在支付页面中，注意您的收货地址是否正确，地址填写错误将会影响您的收货时效。",
						vm.$watch("ngIf",
							function () {
								...
								AXIO.dealData(resp, {
									success: function (data) {
										vm.showError = !1,
											...
											prepareRecordCounter(vm.recordList)
									},
									sessionOut: function () {
										$timeout(function () {
											showLoginTip()
									...
									error: function (isNetOk) {
										vm.showError = !0,
											isNetOk ? vm.errorMsg = "暂无数据，请刷新重试" : vm.errorMsg = "网络异常，请稍后重试"
									}
								}),
									scope.$apply(),
									delete $window.getRecordListCallback
							},
								AXIO.post4Data({
									params: {
										cgName: vm.cgName
